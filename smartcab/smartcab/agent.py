...
def run():
    ...
    ########################################################################################################
    env = Environment()
    #env = Environment(num_dummies = 80, verbose = False, grid_size = (6,4))
    ...
    #agent = env.create_agent(LearningAgent, epsilon = 0.9,alpha = 0.4)
    ##############
    ...
    #sim = Simulator(env, update_delay = 1.5, display = True)
